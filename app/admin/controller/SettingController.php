...
class SettingController extends AdminBaseController
{
    ...
    public function site()
    {
        ...
        $this->assign("user_agreement", $userAgreement['user_agreement']);
        $this->assign("privacy_agreement", $privacyAgreement['privacy_agreement']);
    ...
    public function sitePost()
    {
        if ($this->request->isPost()) {
            ...
            //用户协议及隐私协议
            $userAgreement['user_agreement'] = htmlspecialchars_decode($this->request->param('user_agreement'));
            cmf_set_option('user_agreement', $userAgreement);
            $privacyAgreement['privacy_agreement'] = htmlspecialchars_decode($this->request->param('privacy_agreement'));
            cmf_set_option('privacy_agreement', $privacyAgreement);
